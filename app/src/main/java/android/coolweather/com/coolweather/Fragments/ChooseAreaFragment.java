package android.coolweather.com.coolweather.Fragments;
...
private int currentLevel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);    //listView的监听事件
